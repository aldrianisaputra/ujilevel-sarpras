                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarlaporan">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="tampil.php">Tampil Laporan</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                ...
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">Data Laporan Peminjaman</h4>
                                    <hr><br>
                                        ...
                                        <div class="tab-pane show active" id="striped-rows-preview">
                                            <div class="table-responsive-sm">
                                                <table class="table table-striped table-hover">
                                                    ...
                                                    <?php
                                                    $sql = "SELECT * FROM laporan_sarpras";
                                                    $query =  mysqli_query($connect, $sql);
                                                    while ($laporan = mysqli_fetch_array($query)) {
                                                        echo "<tr>";
                                                        echo "<td>" . $laporan['id_peminjaman'] . "</td>";
                                                        echo "<td>" . $laporan['nama_pegawai'] . "</td>";
                                                        echo "<td>" . $laporan['nama_pengguna'] . "</td>";
                                                        echo "<td>" . $laporan['nama_barang'] . "</td>";
                                                        echo "<td>" . $laporan['jumlah'] . "</td>";
                                                        echo "<td>" . $laporan['tgl_peminjaman'] . "</td>";
                                                        echo "<td>" . $laporan['tgl_pengembalian'] . "</td>";
