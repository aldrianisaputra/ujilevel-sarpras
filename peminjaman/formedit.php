                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarlaporan" aria-expanded="false"
                            aria-controls="sidebarlaporan" class="side-nav-link">
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Edit Data Peminjaman</h4>
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table table-striped table-centered mb-0">
                                                <form action="edit.php" method="POST">
                                                    <div class="mb-3 row">
                                                        <label for="id_peminjaman" class="col-sm-2 col-form-label"></label>
                                                        <div class="col-sm-10">
                                                            <input type="hidden" class="form-control" name="id_peminjaman" value="<?php echo $peminjaman['id_peminjaman'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="nama_pegawai" class="col-sm-2 col-form-label">Nama Pegawai</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="nama_pegawai" value="<?php echo $peminjaman['nama_pegawai'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="nama_pengguna" class="col-sm-2 col-form-label">Nama User</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="nama_pengguna" value="<?php echo $peminjaman['nama_pengguna'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="nama_barang" class="col-sm-2 col-form-label">Nama Barang</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="nama_barang" value="<?php echo $peminjaman['nama_barang'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="jumlah" class="col-sm-2 col-form-label">Jumlah</label>
                                                        <div class="col-sm-10">
                                                            <input type="number" class="form-control" name="jumlah" value="<?php echo $peminjaman['jumlah'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="tgl_peminjaman" class="col-sm-2 col-form-label">Tanggal peminjaman</label>
                                                        <div class="col-sm-10">
                                                            <input type="date" class="form-control" name="tgl_peminjaman" value="<?php echo $peminjaman['tgl_peminjaman'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mt-4">
