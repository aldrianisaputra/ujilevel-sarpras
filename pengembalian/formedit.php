                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarpengembalian">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="pengembalian.php">Tambah Data</a>
                                </li>
                                <li>
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="tampil.php">Data Pengembalian</a></li>
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table table-striped table-centered mb-0">
                                                <form action="edit.php" method="POST">
                                                    <div class="mb-3 row">
                                                        <label for="id_pengembalian" class="col-sm-2 col-form-label"></label>
                                                        <div class="col-sm-10">
                                                            <input type="hidden" class="form-control" name="id_pengembalian" value="<?php echo $pengembalian['id_pengembalian'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="nama_pengguna" class="col-sm-2 col-form-label">Id user</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="nama_pengguna" value="<?php echo $pengembalian['nama_pengguna'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="id_barang" class="col-sm-2 col-form-label">nama barang</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="nama_barang" value="<?php echo $pengembalian['nama_barang'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="jumlah" class="col-sm-2 col-form-label">Jumlah</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="jumlah" value="<?php echo $pengembalian['jumlah'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="tgl_pengembalian" class="col-sm-2 col-form-label">Tanggal pengembalian</label>
                                                        <div class="col-sm-10">
                                                            <input type="date" class="form-control" name="tgl_pengembalian" value="<?php echo $pengembalian['tgl_pengembalian'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mt-4">
