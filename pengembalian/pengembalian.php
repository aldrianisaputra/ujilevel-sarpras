                ...
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title"><b>Input Data Pengembalian</b></h4><br>
                                                        ...
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select name="nama_pengguna" class="form-select " style="width:800px;">
                                                                    ...
                                                                    $query    = mysqli_query($connect, "SELECT * FROM peminjaman GROUP BY id_peminjaman ORDER BY id_peminjaman");
