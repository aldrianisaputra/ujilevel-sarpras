                                        ...
                                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $pengembalian['nama_pengguna'] ?></td>
                                                    <td><?php echo $pengembalian['nama_barang']  ?></td>
                                                    <td><?php echo $pengembalian['jumlah']  ?></td>
                                                    <td><?php echo $pengembalian['tgl_pengembalian']  ?></td>

                                                    <td>
                                                        <a href="formedit.php?id_pengembalian=<?php echo  $pengembalian['id_pengembalian'] ?>" <i class='mdi mdi-pencil'></i></a>
                                                        <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="hapus.php?id_pengembalian=<?php echo $pengembalian['id_pengembalian'] ?>" <i class='mdi mdi-delete'></i></a>
                                                    </td>
