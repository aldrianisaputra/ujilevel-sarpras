        ...
        <div class="content-page">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title;">Data Inventory</h4>
                            <hr>
                            <br>
                            <div class="tab-content">
                                <div class="tab-pane show active" id="basic-datatable-preview">
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $inventory['id_barang'] ?></td>
                                                <td><?php echo $inventory['nama_barang'] ?></td>
                                                <td><?php echo $inventory['jumlah'] ?></td>
                                                <td><?php echo $inventory['unit']  ?></td>

                                                <td>
                                                    <a href="formedit.php?id_barang=<?php echo  $inventory['id_barang'] ?>" <i class='mdi mdi-pencil'></i></a>
                                                    <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="hapus.php?id_barang=<?php echo $inventory['id_barang'] ?>" <i class='mdi mdi-delete'></i></a>
                                                </td>
