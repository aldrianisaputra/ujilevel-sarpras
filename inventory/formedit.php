            ...
            <div class="content">
                    ...
                    <ul class="list-unstyled topbar-menu float-end mb-0">
                        <li class="dropdown notification-list topbar-dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#"
                                ...
                                <img src="../assets/images/flags/indonesia.png" alt="user-image" class="me-0 me-sm-1"
                                    height="12">
                        ...
                        <li class="dropdown notification-list d-none d-sm-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg p-0">
                                ...
                                <div class="p-2">
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" <a
                                                href="https://www.instagram.com/thizaldriani/" target="_blank" >
                                        ...
                                        <div class="col">
                                            <a class="dropdown-icon-item"
                                                href="https://www.youtube.com/channel/UCNk2MaoCtO670BNgel6C0Kw" target="_blank">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Edit Data Inventory</h4>
                                            ...
                                            <table class="table table-striped table-centered mb-0">
                                                <form action="edit.php" method="POST">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="hidden" class="form-control" name="id_barang" value="<?php echo $inventory['id_barang'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="nama" class="col-sm-2 col-form-label">Nama barang</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="nama_barang" value="<?php echo $inventory['nama_barang'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="jumlah" class="col-sm-2 col-form-label">Jumlah</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="jumlah" value="<?php echo $inventory['jumlah'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="Unit" class="col-sm-2 col-form-label">Unit</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="unit" value="<?php echo $inventory['unit'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mt-4">
