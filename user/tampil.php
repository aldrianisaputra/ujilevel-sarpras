                                        ...
                                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="formedit.php?id_pengguna=<?php echo  $pengguna['id_pengguna'] ?>"<i class='mdi mdi-pencil'></i></a> 
                                                        <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="hapus.php?id_pengguna=<?php echo $pengguna['id_pengguna'] ?>" <i class='mdi mdi-delete'></i></a>
                                                    </td>
