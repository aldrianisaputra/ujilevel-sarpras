                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarpengguna">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="pengguna.php">Tambah Data</a>
                                </li>
                                <li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarInventory">
                            <ul class="side-nav-second-level">
                                ...
                                <li>
                                    <a href="../inventory/inventory.php">Tampil Data</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="tampil.php">Data User</a></li>
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table table-striped table-centered mb-0">
                                                <form action="edit.php" method="POST">
                                                    <div class="mb-3 row">
                                                        <label for="id_pengguna" class="col-sm-2 col-form-label"></label>
                                                        <div class="col-sm-10">
                                                            <input type="hidden" class="form-control" name="id_pengguna" value="<?php echo $pengguna['id_pengguna'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="nama_user" class="col-sm-2 col-form-label">Nama User</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="nama_pengguna" value="<?php echo $pengguna['nama_pengguna'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="telepon" value="<?php echo $pengguna['telepon'] ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="mt-4">
