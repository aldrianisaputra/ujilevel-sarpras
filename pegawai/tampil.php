        ...
        <div class="leftside-menu">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar="">
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarpengguna" aria-expanded="false" aria-controls="sidebapengguna" class="side-nav-link">
                                                    ...
                                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="formedit.php?id_pegawai=<?php echo  $pegawai['id_pegawai'] ?>" <i class='mdi mdi-pencil'></i></a>
                                                                    <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="hapus.php?id_pegawai=<?php echo $pegawai['id_pegawai'] ?>" <i class='mdi mdi-delete'></i></a>
                                                                </td>
